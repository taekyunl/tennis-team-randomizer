...
export function StandingsTable({ standings, records, onDeleteRecord }: StandingsTableProps) {
  return (
    <div className="space-y-6">
      <div className="rounded-[24px] border border-line bg-panelElevated/70 p-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="text-xs uppercase tracking-[0.24em] text-accent/80">Standings</p>
            <h3 className="mt-2 text-lg font-semibold text-ink">현재 순위</h3>
          </div>
